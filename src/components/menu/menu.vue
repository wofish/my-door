    ...
    export default {
        data() {
            return {
                ...
                current: 1,
                dataList: [
                    {value: 'WAITING_FOR_TRANSFER', status: '等待放款'},
                    {value: 'TRANSFER_SUCCEED', status: '放款成功'},
                    {value: 'TRANSFER_FAILED', status: '放款失败'},
                    {value: 'FAILED_BID', status: '流标'}
                ],
                vertifyList: [
                    {status: 'loanId', value: '订单号'},
                    {status: 'mobile', value: '手机号'},
                    {status: 'name', value: '姓名'}
                ],
                chosenApplyNos: [],
                ajaxHistoryData: [],
                historyColumns: [
